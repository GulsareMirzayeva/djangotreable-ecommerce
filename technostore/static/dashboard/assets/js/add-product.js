(function($) {
    ...
    $(document).ready(function() {
        ...
        // // Etiketle ilgili JavaScript kodun içinde
        // $('#addTags').on('click', function(){
        //     // Etiketleri gizli giriş alanına ekleyin
        //     var tags = $('#allTags .item').map(function() {
        //         return $(this).text().trim();
        //     }).get().join(',');
        //     $('#productTagsInput').val(tags);
        // });

        // // Etiket kaldırma işlemini ele alın
        // $(document).on('click', '.close-tag', function(){
        //     // Etiketleri gizli giriş alanından kaldırın
        //     var tags = $('#allTags .item').map(function() {
        //         return $(this).text().trim();
        //     }).get().join(',');
        //     $('#productTagsInput').val(tags);
